...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 py-12 px-4 sm:px-6 lg:px-8">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div
                    className={`flex items-center gap-1.5 ${
                      hasMinLength ? "text-emerald-300" : "text-white/50"
                    }`}
                  >
                    {hasMinLength ? (
                  ...
                  <div
                    className={`flex items-center gap-1.5 ${
                      hasUppercase ? "text-emerald-300" : "text-white/50"
                    }`}
                  >
                    {hasUppercase ? (
                      <CheckIcon className="h-3.5 w-3.5" />
                  ...
                  <div
                    className={`flex items-center gap-1.5 ${
                      hasLowercase ? "text-emerald-300" : "text-white/50"
                    }`}
                  >
                    {hasLowercase ? (
                      <CheckIcon className="h-3.5 w-3.5" />
                  ...
                  <div
                    className={`flex items-center gap-1.5 ${
                      hasNumber ? "text-emerald-300" : "text-white/50"
                    }`}
                  >
                    {hasNumber ? (
                      <CheckIcon className="h-3.5 w-3.5" />
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-12 pr-12 py-3.5 bg-white/10 border rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-200 backdrop-blur-sm ${
                  confirmPassword
                    ? passwordsMatch
            ...
            <button
              ...
              className="w-full py-3.5 px-4 bg-white text-teal-600 font-semibold rounded-xl shadow-lg hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-teal-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
            >
              {isSubmitting ? (
